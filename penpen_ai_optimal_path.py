...
# 🧠 최적 경로 
optimal_path = [(1, 1), (2, 1), (2, 2), (2, 3), (2, 4), (3, 4), (4, 4), (5, 4), (6, 4), (6, 5), (6, 6), (6, 7), (7, 7), (8, 7), (9, 7), (10, 7), (10, 6), (10, 5), (10, 4), (11, 4), (12, 4), (13, 4), (14, 4), (14, 5), (14, 6), (14, 7), (15, 7), (16, 7), (17, 7), (17, 6), (17, 5), (17, 4), (17, 3), (17, 2), (18, 2), (18, 1), (19, 1), (20, 1), (21, 1), (22, 1)   ]
...
def set_stage():
    ...
    candy = 0
    red_sx = 600  # Adjusted from 630
    red_sy = 420  # Adjusted from 450
    kuma_sd = -1
...
def draw_screen():
    ...
    for (x, y) in replay_path:
        canvas.create_rectangle(x*60+15, y*60+15, x*60+45, y*60+45, fill="cyan", stipple="gray50", tag="SCREEN")
    canvas.create_image(pen_x + 30, pen_y + 30, image=img_pen[pen_a], tag="SCREEN")
    canvas.create_image(red_x + 30, red_y + 30, image=img_red[red_a], tag="SCREEN")
